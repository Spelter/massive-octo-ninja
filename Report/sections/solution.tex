...
\noindent
Our biggest complaint about the current solution is that it's very fragmented and requires lots of labour-hours. There are, in our experience, disrepencies between what is 
...
a CMS and LMS system that envelopes the whole of NTNU. It does sound very ambitious, luckily the plan is not to create a huge blob of software, but rather a modularised tiered 
platform where data is stored in a centralized storage. The idea is to create a secure, robust, and managable platform which is testable, modularized, and compartmentalized.
...
According to Google Zeitgeist (search statistics) \cite{google:zeiteist} people are to lazy to type in facebook.com, they just search for ``facebook''. Granted, the average NTNU 
...
take action and manually merge the disrepency. %not sure about this last part(?)
